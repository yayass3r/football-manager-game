...
import { Gift, Tv, Dumbbell } from 'lucide-react'

export default function HomeTab() {
  const { user, club, matchHistory, fetchHistory, claimDailyReward, watchAd, isLoading } = useGameStore()
    ...
    <div className="space-y-4 pb-4">
      ...
      >
        ...
        >
          ...
          <span className="text-[10px] font-bold">المكافأة اليومية</span>
        </Button>
        <Button
          onClick={watchAd}
          disabled={isLoading}
        ...
        >
          ...
          <span className="text-[10px] font-bold">شاهد إعلان</span>
        </Button>
        <Button
        ...
        >
          ...
          <span className="text-[10px] font-bold">تدريب الكل</span>
        </Button>
      </motion.div>
