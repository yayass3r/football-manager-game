...
CREATE TABLE IF NOT EXISTS "users" (
    ...
    "coins" INTEGER NOT NULL DEFAULT 5000, "gems" INTEGER NOT NULL DEFAULT 50,
    "level" INTEGER NOT NULL DEFAULT 1, "xp" INTEGER NOT NULL DEFAULT 0,
    "avatar" TEXT NOT NULL DEFAULT '⚽', "soundEnabled" BOOLEAN NOT NULL DEFAULT true,
    "totalWins" INTEGER NOT NULL DEFAULT 0, "totalTrophies" INTEGER NOT NULL DEFAULT 0,
    "isAdmin" BOOLEAN NOT NULL DEFAULT false, "isBanned" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE IF NOT EXISTS "clubs" (
    "id" TEXT NOT NULL, "name" TEXT NOT NULL, "logo" TEXT NOT NULL DEFAULT '🏟️',
    "primary_color" TEXT NOT NULL DEFAULT '#1a8f3f', "secondary_color" TEXT NOT NULL DEFAULT '#ffffff',
    "formation" TEXT NOT NULL DEFAULT '4-3-3', "morale" INTEGER NOT NULL DEFAULT 75,
    "reputation" INTEGER NOT NULL DEFAULT 50, "wins" INTEGER NOT NULL DEFAULT 0,
    ...
    "stadium_name" TEXT NOT NULL DEFAULT 'الملعب الرئيسي', "stadium_level" INTEGER NOT NULL DEFAULT 1,
    "kit_style" TEXT NOT NULL DEFAULT 'classic', "kit_pattern" TEXT NOT NULL DEFAULT 'plain',
    "season_points" INTEGER NOT NULL DEFAULT 0, "season_number" INTEGER NOT NULL DEFAULT 1,
    "title" TEXT NOT NULL DEFAULT '', "user_id" TEXT NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "players" (
    "id" TEXT NOT NULL, "name" TEXT NOT NULL, "position" TEXT NOT NULL,
    "nationality" TEXT NOT NULL, "age" INTEGER NOT NULL, "overall" INTEGER NOT NULL,
    "pace" INTEGER NOT NULL, "shooting" INTEGER NOT NULL, "passing" INTEGER NOT NULL,
    "dribbling" INTEGER NOT NULL, "defending" INTEGER NOT NULL, "physical" INTEGER NOT NULL,
    "potential" INTEGER NOT NULL, "value" INTEGER NOT NULL, "salary" INTEGER NOT NULL,
    "morale" INTEGER NOT NULL DEFAULT 75, "fitness" INTEGER NOT NULL DEFAULT 100,
    "form" INTEGER NOT NULL DEFAULT 75, "is_starter" BOOLEAN NOT NULL DEFAULT false,
    "shirt_number" INTEGER, "club_id" TEXT NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "tournaments" (
    ...
    "tier" INTEGER NOT NULL DEFAULT 1, "max_teams" INTEGER NOT NULL DEFAULT 16,
    "prize" INTEGER NOT NULL, "prize_gems" INTEGER NOT NULL DEFAULT 0,
    "season" INTEGER NOT NULL DEFAULT 1, "status" TEXT NOT NULL DEFAULT 'registration',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "tournaments_pkey" PRIMARY KEY ("id")
);
CREATE TABLE IF NOT EXISTS "tournament_participants" (
    "id" TEXT NOT NULL, "tournament_id" TEXT NOT NULL, "club_id" TEXT NOT NULL,
    "group_number" INTEGER NOT NULL DEFAULT 1, "points" INTEGER NOT NULL DEFAULT 0,
    "played" INTEGER NOT NULL DEFAULT 0, "won" INTEGER NOT NULL DEFAULT 0,
    "drawn" INTEGER NOT NULL DEFAULT 0, "lost" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "matches" (
    "id" TEXT NOT NULL, "tournament_id" TEXT, "home_club_id" TEXT NOT NULL,
    "away_club_id" TEXT NOT NULL, "home_goals" INTEGER NOT NULL DEFAULT 0,
    "away_goals" INTEGER NOT NULL DEFAULT 0, "status" TEXT NOT NULL DEFAULT 'scheduled',
    "match_day" INTEGER NOT NULL DEFAULT 1, "events" TEXT NOT NULL DEFAULT '[]',
    "played_at" TIMESTAMP(3), "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "matches_pkey" PRIMARY KEY ("id")
);
CREATE TABLE IF NOT EXISTS "transfer_listings" (
    "id" TEXT NOT NULL, "player_id" TEXT NOT NULL, "seller_club_id" TEXT NOT NULL,
    "price" INTEGER NOT NULL, "status" TEXT NOT NULL DEFAULT 'active',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "transfer_listings_pkey" PRIMARY KEY ("id")
);
CREATE TABLE IF NOT EXISTS "user_achievements" (
    "id" TEXT NOT NULL, "user_id" TEXT NOT NULL, "achievement_id" TEXT NOT NULL,
    "unlocked" BOOLEAN NOT NULL DEFAULT false, "claimed" BOOLEAN NOT NULL DEFAULT false,
    "unlocked_at" TIMESTAMP(3), "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "game_events" (
    ...
    "description" TEXT NOT NULL, "start_date" TIMESTAMP(3) NOT NULL,
    "end_date" TIMESTAMP(3) NOT NULL, "is_active" BOOLEAN NOT NULL DEFAULT true,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "game_events_pkey" PRIMARY KEY ("id")
);
CREATE TABLE IF NOT EXISTS "player_packs" (
    "id" TEXT NOT NULL, "name" TEXT NOT NULL, "type" TEXT NOT NULL,
    "price" INTEGER NOT NULL, "gem_price" INTEGER NOT NULL DEFAULT 0,
    "description" TEXT NOT NULL, "min_overall" INTEGER NOT NULL,
    "max_overall" INTEGER NOT NULL, "player_count" INTEGER NOT NULL DEFAULT 1,
    "is_active" BOOLEAN NOT NULL DEFAULT true,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "player_packs_pkey" PRIMARY KEY ("id")
);
CREATE TABLE IF NOT EXISTS "pack_openings" (
    "id" TEXT NOT NULL, "user_id" TEXT NOT NULL, "pack_id" TEXT NOT NULL,
    "players_data" TEXT NOT NULL, "opened_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "pack_openings_pkey" PRIMARY KEY ("id")
);
CREATE TABLE IF NOT EXISTS "achievements" (
    "id" TEXT NOT NULL, "achievement_id" TEXT NOT NULL, "name" TEXT NOT NULL,
    "description" TEXT NOT NULL, "icon" TEXT NOT NULL, "category" TEXT NOT NULL,
    "requirement" INTEGER NOT NULL, "reward_coins" INTEGER NOT NULL DEFAULT 0,
    "reward_gems" INTEGER NOT NULL DEFAULT 0, "reward_title" TEXT,
...
CREATE TABLE IF NOT EXISTS "leaderboard_entries" (
    ...
    "season_id" TEXT, "type" TEXT NOT NULL, "score" INTEGER NOT NULL,
    "rank" INTEGER NOT NULL DEFAULT 0, "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
('tourn_bronze', 'كأس البرونز', 'cup', 1, 16, 5000, 50, 1, 'registration')
...
async function execSql(sql: string): Promise<{ ok: boolean; err?: string }> {
  try {
    ...
    for (const stmt of stmts) {
      try { await prisma.$executeRawUnsafe(stmt); } catch (e: any) {
        if (!e.message?.includes('already exists') && !e.message?.includes('duplicate') && !e.message?.includes('violates')) {
          console.warn('SQL warn:', (e.message || '').substring(0, 100));
        }
      }
    }
...
export async function GET(request: Request) {
  ...
  const logs: string[] = [];
  const r1 = await execSql(CREATE_TABLES_SQL);
  logs.push(r1.ok ? '✅ Tables created' : '❌ Tables: ' + (r1.err || '').substring(0, 100));
  const r2 = await execSql(FK_SQL);
  logs.push(r2.ok ? '✅ Foreign keys added' : '⚠️ FK: ' + (r2.err || '').substring(0, 100));
  const r3 = await execSql(SEED_SQL);
  logs.push(r3.ok ? '✅ Data seeded' : '⚠️ Seed: ' + (r3.err || '').substring(0, 100));
  return NextResponse.json({ status: 'done', logs });
}
